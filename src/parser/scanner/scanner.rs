...
use crate::r#macro::{StringMacro, TokenizedMacro};
use crate::parser::scanner::constants::{DETAILS_TAG, MESSAGE_TAG, SEPARATOR};
use crate::parser::scanner::scan_error::ScanError;
use crate::parser::scanner::scan_error_type::ScanErrorType;
use crate::parser::scanner::scanner_result::ScannerResult;
...
impl Scanner {
    ...
    pub fn scan_file(mut self) -> std::result::Result<TokenizedMarkdown, Vec<ScanError>> {
    ...
    fn scan_frontmatter(&mut self) -> ScannerResult<String> {
        self.consume_spaces();
    ...
    fn scan(&mut self) -> ScannerResult<()> {
    ...
    fn block_element(&mut self) -> ScannerResult<()> {
    ...
    fn extract_until(&mut self, end: &str) -> ScannerResult<()> {
